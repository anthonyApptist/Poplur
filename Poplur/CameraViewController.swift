			...
			switch self.setupResult {
                ...
                case .notAuthorized:
                    DispatchQueue.main.async { [unowned self] in
                        let message = NSLocalizedString("PoplurDemo doesn't have permission to use the camera, please change privacy settings", comment: "Alert message when the user has denied access to the camera")
                        let alertController = UIAlertController(title: "PoplurDemo", message: message, preferredStyle: .alert)
    ...
    func capture(_ captureOutput: AVCaptureFileOutput!, didFinishRecordingToOutputFileAt outputFileURL: URL!, fromConnections connections: [Any]!, error: Error!) {
		...
		*/
		...
		if success {
            ...
            delegate?.videoRecordingComplete(videoURL: outputFileURL as NSURL)
